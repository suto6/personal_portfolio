    ...
    return (
        ...
        >
            <div className="container mx-auto px-4 max-w-4xl">
                <h1 className="text-5xl font-bold mb-12 text-[#00FF00] text-center">Let&apos;s Connect</h1>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <motion.a
                        ...
                        className="flex flex-col items-center gap-4 p-8 rounded-lg bg-[#00FF00] hover:bg-[#00FF00]/80 transition-colors"
                    >
